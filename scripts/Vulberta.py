...
from vulberta.models.tokenization_vulberta import VulBERTaTokenizer
...
class Vulberta(Herramienta):
    ...
    def __init__(
        ...
        nombre: str = "Vulberta", 
        version: str = "1",
        model_path: str = os.path.join("vulberta", "models"),
        chunk_size: int = 512,
        ...
        self.tokenizer = VulBERTaTokenizer.from_pretrained(self.model_path)
